    ...
    let page = dom('html',
      dom('head',
        ...
        dom('script', `
          ...
          })(window,document,'script','dataLayer','GTM-WQWH2XV');
        `),
      ...
      dom('noscript',
          dom('iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WQWH2XV" height="0" width="0" style="display:none;visibility:hidden"')
      ),
